...
class Player(GameSprite):
    ...
    def fire(self):
        bullet = Bullet('wood.png', self.rect.right, self.rect.centery, 15, 20, 15)
        bullets.add(bullet)
...
back = (119, 210, 223)#задаем цвет согласно цветовой схеме RG
...
w1 = GameSprite('wall.png',win_width / 1   - win_width / 1 , win_height / 1, 300, 50)
...
#создаем спрайты
packman = Player('sheep.png', 5, win_height - 80, 80, 80, 0, 0)
final_sprite = GameSprite('flag.png', win_width - 85, win_height - 100, 80, 80)

monster1 = Enemy('wall.png', win_width - 80, 150, 80, 80, 3)
monster2 = Enemy('wall.png', win_width - 80, 230, 80, 80, 4)
